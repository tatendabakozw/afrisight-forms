            ...
            <div className="container mx-auto p-4 flex justify-between items-center">
                ...
                <div className="flex justify-end gap-8">
                    <div className="flex gap-2 items-center">
                        <button onClick={props.openSettingsModal} className="h-[36px] w-[36px] rounded-xl bg-zinc-200 flex items-center justify-center">
                            <GearIcon className="h-5 w-5" />
                        </button>
                        <button className="h-[36px] w-[36px] rounded-xl bg-zinc-200 flex items-center justify-center">
                            <PlayIcon className="h-5 w-5" />
                        </button>
                        <button className="h-[36px] px-4 rounded-xl bg-zinc-200 flex items-center justify-center">
                            Invite
                        </button>
